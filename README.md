...
Современное full-stack веб-приложение для поиска, создания и бронирования мероприятий. Платформа объединяет гостей и организаторов: пользователи могут находить события по категориям, городам и формату, а организаторы — создавать мероприятия и управлять билетами. Все фотографии мероприятий сгенерированы искусственным интеллектом и сохранены локально.
